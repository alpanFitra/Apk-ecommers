	...
	<table class="table table-bordered">
		...
		foreach ($barang as $brg) : ?>
			...
			<tr>
				...
				<td><?php echo $brg->kategory ?></td>
				<td><?php echo $brg->harga ?></td>
				<td><?php echo $brg->stok ?></td>
				<td>
					<div class="btn btn-success btn-sm"><i class="fas fa-search-plus"></i></div>
				</td>
				<td><?php echo anchor('admin/databarang/edit/' . $brg->id_brg, '<div class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></div>') ?>
				</td>
				<td><?php echo anchor('admin/databarang/hapus/' . $brg->id_brg, '<div class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></div>') ?>
				</td>
			</tr>
		<?php endforeach; ?>
	</table>
				...
				<form action="<?php echo base_url() . 'admin/databarang/tambahaksi' ?>" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<select class="form-control" name="kategory">
							...
							<option>Fashion Anak & Bayi</option>
